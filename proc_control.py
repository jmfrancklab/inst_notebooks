...
d = nddata_hdf5('171220_control_chirp.h5/capture1_171220',
            directory=getDATADIR(exp_type='test_equip_shared'))
with figlist_var(filename='171220_control_chirp.pdf') as fl:
