...
response = raw_input("1 for mV to dBm conversion, 2 for dBm to mV conversion: ")

if int(response) == 1:
    mV = raw_input("Enter mV value: ")
    which_diode = raw_input("1 for RX diode calibrated conversion, 2 for TX diode calibrated conversion: ")
