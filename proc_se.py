...
for date,id_string,numchan,indirect_range in [
        ...
        #('180929','spin_echo_2',2,None) # spin echo, B0 = 3405.85
        #('180929','spin_echo_3',2,None) # spin echo, B0 = 3406.1
        ]:
    ...
    s_analytic *= exp(-1j*2*pi*3/4) # phase correction for 180929_spin_echo
    s_analytic.ift('t')
    if not single_90:
